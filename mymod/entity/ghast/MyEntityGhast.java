...
public class MyEntityGhast extends EntityTameable
{
     ...
     */
    public MyEntityGhast spawnBabyAnimal(EntityAgeable par1EntityAgeable)
    {
        MyEntityGhast entitywolf = new MyEntityGhast(this.worldObj);
    ...
    public boolean canMateWith(EntityAnimal par1EntityAnimal)
    {
        ...
        else if (!(par1EntityAnimal instanceof MyEntityGhast))
        {
            return false;
        }
        else
        {
            MyEntityGhast entitywolf = (MyEntityGhast)par1EntityAnimal;
    ...
    public boolean func_142018_a(EntityLivingBase par1EntityLivingBase, EntityLivingBase par2EntityLivingBase)
    {
        ...
        {
            if (par1EntityLivingBase instanceof MyEntityGhast)
            {
                MyEntityGhast entitywolf = (MyEntityGhast)par1EntityLivingBase;
