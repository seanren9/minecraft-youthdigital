...
import api.util.StructureHelper;
import api.util.StructureHelper.StructureData;
...
public class Structure implements IWorldGenerator {
	...
	private float chanceToGenerateInChunk = 100;
	...
	public float getChanceToGenerateInChunk() {
	 ...
	 */
	public void setChanceToGenerateInChunk(float chanceToGenerateInChunk) {
