...
public class EntityHelper {
    ...
    /**
     * Makes entity target an area to move to ahead of where the player is looking
     * 
     * @param player
     * @param entity
     * @param lookAheadDistance How far ahead he should move to
     */
    public static void setTargetFromLook(EntityPlayer player, Entity entity, double lookAheadDistance) {
